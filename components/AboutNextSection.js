...
function AboutNextSection() {
  return (
    <div className="w-full bg-section border-t border-b border-gray-200 py-11">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center px-4 md:h-screen">
        ...
        <div className="mt-11 md:mt-0 lg:w-1/2 lg:pr-16  flex flex-col justify-evenly items-center md:items-start h-5/6">
          ...
          <a className="mt-11 md:mt-0 md:mb-0 bg-blue-500 hover:bg-blue-600 text-gray-200 font-bold py-2 px-4 rounded w-fit" href="https://kinsta.com/fr/base-de-connaissances/next-js/#questce-que-nextjs-" target="_blank">EN APPRENDRE PLUS</a>
        </div>
      </div>
    </div>
  );
